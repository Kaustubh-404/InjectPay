      ...
      <header className="fixed top-0 w-full border-b border-white/10 bg-black/50 backdrop-blur-xl z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-emerald-500 to-emerald-300">InjectPay</span>
          </div>
      ...
      <section className="pt-32 pb-20 relative">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 mb-8 backdrop-blur-md hover:border-emerald-500/30 transition-colors">
            ...
            <span className="text-sm">Powered by INJECTIVE</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-zinc-400 max-w-3xl mx-auto mb-12 backdrop-blur-sm">
            InjectPay is a decentralized platform that automates and secures your recurring payments using smart contracts on the INJECTIVE. Perfect for organizations managing employee payments.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Payments are automated via INJECTIVE smart contracts",
                icon: Boxes
              },
              {
                step: "4",
      ...
      <section id="security" className="py-20 border-t border-white/10 relative">
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-lg text-zinc-400 max-w-2xl mx-auto backdrop-blur-sm">
            InjectPay leverages the power of Electroneum and smart contracts to ensure your recurring payments are secure, transparent, and immutable.
          </p>
